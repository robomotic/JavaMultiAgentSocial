...
public final class MutableDouble3D implements java.io.Serializable, Cloneable
    ...
    public MutableDouble3D divideIn(MutableDouble3D me, MutableDouble3D other) {
        this.x=me.x/other.x;
        this.y=me.y/other.y;
        this.z=me.z/other.z;
        return this;
    ...
    public void percentage(MutableDouble3D me, double Wdistal0) {
        this.x=Math.abs(me.x/Wdistal0)*100.0;
        this.y=Math.abs(me.y/Wdistal0)*100.0;
        this.z=Math.abs(me.z/Wdistal0)*100.0;
    }
    ...
    public final MutableDouble3D maxima(final MutableDouble3D other)
    {
    ...
    public void multiplyDot(MutableDouble3D me, MutableDouble3D other) {
        me.x = me.x * other.x;
        me.y = me.y * other.y;
        me.z = me.z * other.z;
    }
